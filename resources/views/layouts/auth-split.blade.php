...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased text-gray-900 bg-white">
        <div class="min-h-screen flex">
            ...
            <div class="hidden lg:flex lg:w-1/2 bg-indigo-900 relative overflow-hidden">
                ...
                <div class="relative z-10 w-full flex flex-col justify-center px-12 text-white">
                    ...
                    <h1 class="text-4xl font-bold mb-4">Industrial Sales Management</h1>
                    <p class="text-indigo-200 text-lg leading-relaxed">
                        Streamline your inventory, manage customer relationships, and track sales orders in one powerful platform.
                    </p>
                </div>
            </div>
